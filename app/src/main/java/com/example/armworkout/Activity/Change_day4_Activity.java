...
public class Change_day4_Activity extends AppCompatActivity {

    AnimationDrawable frameAnimation;
    ImageView image_change;
    CardView btn_chagne;
    int current_image;
    int [] images = {R.drawable.anim7right,R.drawable.anim1,R.drawable.anim11,R.drawable.anim14,
            R.drawable.anim15,R.drawable.anim9,R.drawable.anim1,R.drawable.anim10,R.drawable.anim7};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_change_day4_);
        ...
        myTTS = new TextToSpeech(this, new TextToSpeech.OnInitListener() {
            ...
            public void onInit(int status) {
                ...
                if (myTTS.getEngines().size()==0){
                    Toast.makeText(Change_day4_Activity.this,"The are no TTs device on your device",Toast.LENGTH_SHORT).show();
                    finish();
                }else{
