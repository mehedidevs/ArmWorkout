...
public class Day7_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_day7_);
        ...
        animImageView2.setBackgroundResource(R.drawable.anim8); //change
        animImageView.setBackgroundResource(R.drawable.anim2); //change
        animImageView3.setBackgroundResource(R.drawable.anim13); //change
        animImageView4.setBackgroundResource(R.drawable.anim20); //change
        animImageView5.setBackgroundResource(R.drawable.anim5);
        animImageVIew6.setBackgroundResource(R.drawable.anim8); //
        animImageView7.setBackgroundResource(R.drawable.anim13); //
        animImageView8.setBackgroundResource(R.drawable.anim7); ///
        animImageView9.setBackgroundResource(R.drawable.anim7right); ///
                ...
                if (mInterstitialAd.isLoaded()){
                    ...
                    mInterstitialAd.setAdListener(new AdListener(){
                        ...
                        public void onAdClosed() {
                            super.onAdClosed();
                            Intent intent = new Intent(getApplicationContext(),Change_day7_Activity.class);
