...
public class Change_day2_Activity extends AppCompatActivity {

    AnimationDrawable frameAnimation;
    ImageView image_change;
    CardView btn_chagne;
    int current_image;
    int [] images = {R.drawable.anim10,R.drawable.anim1,R.drawable.anim2,R.drawable.anim8,
            R.drawable.anim4,R.drawable.anim9,R.drawable.anim1};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_change_day2_);
        ...
        myTTS = new TextToSpeech(this, new TextToSpeech.OnInitListener() {
            ...
            public void onInit(int status) {
                ...
                if (myTTS.getEngines().size()==0){
                    Toast.makeText(Change_day2_Activity.this,"The are no TTs device on your device",Toast.LENGTH_SHORT).show();
                    finish();
                }else{
                    myTTS.setLanguage(Locale.US);
                    speak("hello,are you ready to workout,,? make sure you are counting upto 30 times ");
                }
            }
        });
    }
        ...
        myTTS = new TextToSpeech(this, new TextToSpeech.OnInitListener() {
            ...
            public void onInit(int status) {
                ...
                if (myTTS.getEngines().size()==0){
                    ...
                    myTTS.setLanguage(Locale.US);
                    speak(" if you have done 30 times this exercise then it is done, otherwise wait till 30 ok ,,,,,,,,,,,,,,,,,,      now take some rest.After that, press the next button");
                }
            }
        });
    }
