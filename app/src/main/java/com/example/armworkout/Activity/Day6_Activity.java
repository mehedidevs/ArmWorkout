...
public class Day6_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_day6_);
        ...
        animImageView2.setBackgroundResource(R.drawable.anim14); //chagn
        animImageView.setBackgroundResource(R.drawable.anim16); //change
        animImageView3.setBackgroundResource(R.drawable.anim17);//change
        animImageView4.setBackgroundResource(R.drawable.anim18); ///change
        animImageView5.setBackgroundResource(R.drawable.anim19); //change
        animImageVIew6.setBackgroundResource(R.drawable.anim12); //change
        animImageView7.setBackgroundResource(R.drawable.anim14); //change
                ...
                if (mInterstitialAd.isLoaded()){
                    ...
                    mInterstitialAd.setAdListener(new AdListener(){
                        ...
                        public void onAdClosed() {
                            super.onAdClosed();
                            Intent intent = new Intent(getApplicationContext(),Change_day6_Activity.class);
