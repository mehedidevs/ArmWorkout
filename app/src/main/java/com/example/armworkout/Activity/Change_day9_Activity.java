...
public class Change_day9_Activity extends AppCompatActivity {

    AnimationDrawable frameAnimation;
    ImageView image_change;
    CardView btn_chagne;
    int current_image;
    int [] images = {R.drawable.anim8,R.drawable.anim16,R.drawable.anim14,R.drawable.anim21,
            R.drawable.anim17,R.drawable.anim12,R.drawable.anim22,R.drawable.anim23,R.drawable.anim24};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_change_day9_);
        ...
        myTTS = new TextToSpeech(this, new TextToSpeech.OnInitListener() {
            ...
            public void onInit(int status) {
                ...
                if (myTTS.getEngines().size()==0){
                    Toast.makeText(Change_day9_Activity.this,"The are no TTs device on your device",Toast.LENGTH_SHORT).show();
                    finish();
                }else{
