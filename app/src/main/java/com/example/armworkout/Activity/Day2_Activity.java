...
public class Day2_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_day2_);
        ...
        animImageView3.setBackgroundResource(R.drawable.anim8);
        animImageView4.setBackgroundResource(R.drawable.anim4);
        animImageView5.setBackgroundResource(R.drawable.anim9);
        animImageVIew6.setBackgroundResource(R.drawable.anim8);
        animImageView7.setBackgroundResource(R.drawable.anim1);
        animImageView8.setBackgroundResource(R.drawable.anim10);
                ...
                if (mInterstitialAd.isLoaded()){
                    ...
                    mInterstitialAd.setAdListener(new AdListener(){
                        ...
                        public void onAdClosed() {
                            super.onAdClosed();
                            Intent intent = new Intent(getApplicationContext(),Change_day2_Activity.class);
