...
public class Day9_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_day9_);
        ...
        animImageView2.setBackgroundResource(R.drawable.anim14); //c
        animImageView.setBackgroundResource(R.drawable.anim16); //c
        animImageView3.setBackgroundResource(R.drawable.anim21); //c
        animImageView4.setBackgroundResource(R.drawable.anim17); //c
        animImageView5.setBackgroundResource(R.drawable.anim12);//c
        animImageVIew6.setBackgroundResource(R.drawable.anim22); //c
        animImageView7.setBackgroundResource(R.drawable.anim23); //c
        animImageView8.setBackgroundResource(R.drawable.anim24); ///c
        animImageView9.setBackgroundResource(R.drawable.anim8); ///
                ...
                if (mInterstitialAd.isLoaded()){
                    ...
                    mInterstitialAd.setAdListener(new AdListener(){
                        ...
                        public void onAdClosed() {
                            super.onAdClosed();
                            Intent intent = new Intent(getApplicationContext(),Change_day9_Activity.class);
    ...
    private void initToollbar() {
        ...
        getSupportActionBar().setTitle("Day 9");
