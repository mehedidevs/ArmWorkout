...
public class Day8_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_day8_);
        ...
        animImageView2.setBackgroundResource(R.drawable.anim15); //change
        animImageView.setBackgroundResource(R.drawable.anim11); //change
        animImageView3.setBackgroundResource(R.drawable.anim19); //change
        animImageView4.setBackgroundResource(R.drawable.anim4); //
        animImageView5.setBackgroundResource(R.drawable.anim5);
        animImageVIew6.setBackgroundResource(R.drawable.anim17); //change
        animImageView7.setBackgroundResource(R.drawable.anim1); //
        animImageView8.setBackgroundResource(R.drawable.anim15); ///
        animImageView9.setBackgroundResource(R.drawable.anim10); ///
                ...
                if (mInterstitialAd.isLoaded()){
                    ...
                    mInterstitialAd.setAdListener(new AdListener(){
                        ...
                        public void onAdClosed() {
                            super.onAdClosed();
                            Intent intent = new Intent(getApplicationContext(),Change_day8_Activity.class);
