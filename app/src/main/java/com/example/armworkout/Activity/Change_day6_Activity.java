...
public class Change_day6_Activity extends AppCompatActivity {

    AnimationDrawable frameAnimation;
    ImageView image_change;
    CardView btn_chagne;
    int current_image;
    int [] images = {R.drawable.anim7right,R.drawable.anim16,R.drawable.anim14,R.drawable.anim17,
            R.drawable.anim18,R.drawable.anim19,R.drawable.anim12,R.drawable.anim14,R.drawable.anim7};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_change_day6_);
        ...
        myTTS = new TextToSpeech(this, new TextToSpeech.OnInitListener() {
            ...
            public void onInit(int status) {
                ...
                if (myTTS.getEngines().size()==0){
                    Toast.makeText(Change_day6_Activity.this,"The are no TTs device on your device",Toast.LENGTH_SHORT).show();
                    finish();
                }else{
