...
public class Day3_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_day3_);
        ...
        animImageView.setBackgroundResource(R.drawable.anim11); //11
        animImageView3.setBackgroundResource(R.drawable.anim12);//12
        animImageView4.setBackgroundResource(R.drawable.animright13); ///13 left
        animImageView5.setBackgroundResource(R.drawable.anim13); //13 right
        animImageVIew6.setBackgroundResource(R.drawable.anim9);
        animImageView7.setBackgroundResource(R.drawable.anim5);//5
                ...
                if (mInterstitialAd.isLoaded()){
                    ...
                    mInterstitialAd.setAdListener(new AdListener(){
                        ...
                        public void onAdClosed() {
                            super.onAdClosed();
                            Intent intent = new Intent(getApplicationContext(),Change_day3_Activity.class);
