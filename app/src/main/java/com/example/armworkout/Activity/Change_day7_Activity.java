...
public class Change_day7_Activity extends AppCompatActivity {

    AnimationDrawable frameAnimation;
    ImageView image_change;
    CardView btn_chagne;
    int current_image;
    int [] images = {R.drawable.anim7right,R.drawable.anim2,R.drawable.anim8,R.drawable.anim13,
            R.drawable.anim20,R.drawable.anim5,R.drawable.anim8,R.drawable.anim13,R.drawable.anim7};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_change_day7_);
        ...
        myTTS = new TextToSpeech(this, new TextToSpeech.OnInitListener() {
            ...
            public void onInit(int status) {
                ...
                if (myTTS.getEngines().size()==0){
                    Toast.makeText(Change_day7_Activity.this,"The are no TTs device on your device",Toast.LENGTH_SHORT).show();
                    finish();
                }else{
